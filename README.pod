...
The module is distributed via CPAN.

You can install it with a simple C<cpan> or C<cpanm> command.

If you already have cpan configured (e.g. on Strawberry Perl)

  cpan App::Prima::REPL

On Linux/OSX you can use cpanminus.

  curl -L http://cpanmin.us | perl - App::cpanminus
  cpanm App::Prima::REPL

PDL::Drawing::Prima and PDL::Graphics::Prima are additional modules
available on CPAN, that provide very nice plotting capabilities for PDL,
so if you use PDL I highly recommend installing those too.

=head2 Manual installation

In case the above does not work you might want to fall back to
manual installation of the modules:
...
Copyright (C) 2011, 2012, 2013 David Mertens
